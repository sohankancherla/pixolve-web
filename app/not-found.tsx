...
export default function NotFound() {
  return (
    <main className="min-h-screen grid place-items-center py-32 px-8 bg-gradient-to-bl from-[#ffffff] to-[#e8e8e8] dark:from-[#1f1f1f] dark:to-[#121317]">
      <section className="text-center font-display font-medium">
        ...
        <div className="m-6 sm:mt-8 flex justify-center">
          <BackHome />
        </div>
      </section>
    </main>
